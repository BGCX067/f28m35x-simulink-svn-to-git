...
#include "MW_c28xx_adc.h"       // Prototype of function config_ADC_SOC_Trigger1()
...
/*
 *  Trigger1 associated with ePWM1SOCA (because of simulink compatibility)
 */
void config_ADC_SOC_TRIG1()
{
	EALLOW;
	AnalogSysctrlRegs.TRIG1SEL.all = 5; // Set ePWM1SOCA as trigger source for ADC.
	EDIS;
}

/*
 *  Trigger1 associated with ePWM2SOCA (because of simulink compatibility)
 */
void config_ADC_SOC_TRIG3()
{
	EALLOW;
	AnalogSysctrlRegs.TRIG3SEL.all = 8; // Set ePWM2SOCA as trigger source for ADC.
	EDIS;
}
